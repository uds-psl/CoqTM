...
\section{$\Nop$}
\label{sec:Nop}
\setCoqFilename{FormalComplexity.TM.Compound.Multi}%
...
\setCoqFilename{FormalComplexity.TM.Compound.WriteString}%
...
\setCoqFilename{FormalComplexity.TM.Compound.CopySymbols}%
...
that satisfies the boolean predicate $h$.  We leave out the correctness and runtime statements, as they can be derived from the statements about
