...
\begin{lemma}[Correctness of $\MS{Match}~M~f$ in constant time]
...
\begin{lemma}[Runtime of sequential composition]
...
\begin{lemma}[Runtime of the conditional]
...
\begin{fact}[Alternative specification of $\While~M$]
  ~
  \[
