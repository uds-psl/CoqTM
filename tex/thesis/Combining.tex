...
When we want to show $\While~M \TerminatesIn T$, this is dual to show $\While~M \Realise R$.  We apply the anti-monotonicity
Lemma~\ref{lem:TerminatesIn_monotone} and the above runtime lemma, and have to show $T \subseteq WhileT~R~T'$.  Therefore, we use the co-induction
lemma of $WhileT$:
\begin{lemma}[$WhileT$ co-induction]
