...
We use $\bigcup_{c:A} R$ as a notation for $\lambda a~b.~\exists c.~R~a~b$, i.e.\ we use $c$ as binder in $R$ here.  We can also define the reflexive
transitive closure of binary relations, also known as relational Kleene star:
