...
From the correctness and runtime of $\MS{AddLoop}$, we conclude the correctness and runtime of $\MS{Add}$.  For the runtime function, we have to add
linear components for the copying of $m$ and $n$.
...
We want to define an operator that takes machines $M_1, M_2$ that compute the unary functions $f$ and $g$, and yields a machine that computes the
function $(f+g)$.
