...
\begin{lemma}[Correctness of $\MS{MultLoop}$]
  ...
  \begin{alignat*}{2}
    ...
    &&& t[0] \simeq m \rightarrow t[1] \simeqnb \rightarrow t[2] \simeq c \rightarrow isRigth~t[3] \rightarrow isRight~t[4] \rightarrow \\
...
\begin{lemma}[Runtime of $\MS{Mult}$]
  There is a function $MultSteps : \Nat\to\Nat\to\Nat \in \Option(m+n^2)$, such that
  $\MS{Mult} \TerminatesIn MultSteps$.
\end{lemma}
