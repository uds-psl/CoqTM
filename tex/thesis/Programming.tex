...
\begin{definition}[Basic encodings]
  ...
  \coqitem[Encode_sum] Let $X$ be encodable on $\Sigma_X$ and $Y$ on $\Sigma_Y$.  Then $X+Y$ is encodable on
    ...
    \end{alignat*}
  \coqitem[Encode_prod] Let $X$ be encodable on $\Sigma_X$ and $Y$ on $\Sigma_Y$.  Then $X \times Y$ is encodable on
...
\begin{lemma}[Correctness of $\MS{CasePair}$][CasePair_Realise]
  ...
  \]
\end{lemma}
\begin{lemma}[Runtime of $\MS{CasePair}$][CasePair_Terminates]
...
\begin{figure}
  ...
  \end{tikzcd}
  \caption{Retractions involved in the definition of $\MS{MapSum}$.  The diagram does not necessarily have to commute.}
  ...
  \end{tikzcd}
  \caption{Retractions involved in the definition of $\MS{Nth}$.  The diagram does not necessarily have to commute.}
