...
\todo{This table is \textit{not} complete!  Also remove the library part from the total sum.  Recount everything, before releasing the thesis.}
...
The total number of library lines is $153$ spec and $2638$ proof.
