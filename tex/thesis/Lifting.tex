...
Ricciotti~\cite{asperti2015} define an injecting operator that translates a one-tape machine into a $(1+n)$-tape machine.  We generalise this approach
and implement an operator that takes an $m$-tape machine and yields an $n$-tape machine, for $m \le n$.
