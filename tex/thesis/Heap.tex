...
\begin{lemma}[Correctness of $\MS{Step}$]
...
\begin{lemma}[Runtime of $\MS{Step}$]
...
\begin{lemma}[Correctness of $\MS{Loop}$]
...
\begin{lemma}[Runtime of $\MS{Loop}$]
...
\begin{theorem}[Halting problem reduction]
