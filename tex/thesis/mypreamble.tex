...
\newcommand{\LiftTapes}[2]{\Uparrow_{#2} #1}
\newcommand{\LiftAlphabet}[2]{\Uparrow_{#2} #1}
% #1 is the machine, #2 the alphabet lifting, and #3 the tape-lifting
\newcommand{\LiftBoth}[3]{\Uparrow_{#2;~#3} #1}
...
\lstdefinelanguage{semicoq}{
  morekeywords={if,then,else,true,false,match,Match,If,Then,Else,Nop,Return,Move,Reset,DoAct,WriteMove,L,R,N},
  morecomment=[s]{(*}{*)},
}
