...
\lstdefinelanguage{semicoq}{
  keywords={if,then,else,true,false,match,Switch,If,Then,Else,Nop,Return,Move,Reset,DoAct,WriteMove,L,R,N},
  comment=[s]{(*}{*)},
}
...
\newcommand{\pthen}{\phalign{\MS{then}}{{\MS{then}}}}
\newcommand{\pelse}{\phalign{\MS{then}}{{\MS{else}}}}
\newcommand{\pThen}{\phalign{\MS{Then}}{{\MS{Then}}}}
\newcommand{\pElse}{\phalign{\MS{Then}}{{\MS{Else}}}}
